...
{
    this->setWindowTitle("User Wtachapp"); //设置界面标题
    ...
    QFont styleft("Comic Sans MS", 16, 87);
    ...
    QFont spinft("Comic Sans MS", 14, 87);
    ...
    QFont stft("Comic Sans MS", 16, 87);
    ...
    QFont styft("Comic Sans MS", 14, 87);
    fan->setFont(styft);
    fan->setText("FanCon");
    ...
    QFont style_set("Comic Sans MS", 16, 87);
...
void show_pic::playcontrol()
{
    if (play->isChecked())
    {
        view->load(QUrl("http://192.168.3.102:8080/javascript_simple.html"));
    ...
    {
        view->load(QUrl("http://192.168.3.102:8080/static_simple.html"));
    }
}
