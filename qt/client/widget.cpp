    ...
    : QWidget(parent)
{
    ...
    this->setWindowOpacity(0.8); //设置窗体整体半透明
    ...
    QFont styleft("Comic Sans MS", 18, 87);
    ...
    QFont labelft("Comic Sans MS", 16, 87);
    ...
    QFont editft("Comic Sans MS", 16, 87);
    edt_ip->setStyleSheet(editstyle);
    edt_ip->setFont(editft); //设置字体
    edt_ip->setText("192.168.3.131");
