...
if __name__ == '__main__':
    ...
    engineer = factory.create('engineer', 'luo', 25, 'M')
    print(engineer)
    print(engineer.get_count())
    print(engineer.get_role())

    engineer = factory.create('engineer', 'lucy', 25, 'M')
    print(engineer)
    print(engineer.get_count())
    print(engineer.get_role())
    del engineer
    ...
    import weakref
    import gc
    engineer = Engineer('luo', 25, 'M')
    print(len(gc.get_referents(engineer)))
    engineer_w = weakref.proxy(engineer)
    print(engineer_w)
    print(len(gc.get_referents(engineer)))
